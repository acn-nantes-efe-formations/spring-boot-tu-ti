...
import com.accenture.annuaire.controller.config.TestcontainersMariaDBConfig;
...
@ContextConfiguration(initializers = TestcontainersMariaDBConfig.class)
class PersonneRestControllerIntegrationContainerMariadbTest {
